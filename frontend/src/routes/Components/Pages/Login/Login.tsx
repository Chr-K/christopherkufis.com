...
export default function Login(){
    ...
    <div>
        ...
        <input id='confirm_password' className='visibility_none default_animation' placeholder='Confirm Password' onChange={()=>{apply_password('confirm_password')}}></input>
            ...
            <button id='login_submit' className='button_t2 text_t2 float_right white blue_background' onClick={()=>test_login()}>Login</button>
            </div>
        </div>
        ...
        function test_login(){
            ...
            fetch('https://christopherkufis.com/backend/public/index.php',{
                method: 'POST',
                body: formData
            })
